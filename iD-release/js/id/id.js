...
(function() {
	...
	// BRUNO : Forced application to read locale from url instead of navigator parameters;
	detected.locale = location.search.match(new RegExp("locale=([\\w\\-]+)")) ? RegExp.$1.replace(/%22/g, "\"").replace(/%20/g, "") : null;
	/*
