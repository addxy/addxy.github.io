...
module.exports = function(o) {
    ...
    oauth.authenticate = function(callback) {
        ...
        function reqTokenDone(err, xhr) {
			...
			// BRUNO : added fullLanding parameter to allow osmauth to redirect to a full url instead of a url derived from the opener.
			//		   The land.html file contains a page that only closes the popup. The land.html file was taken from the dist folder.
			//		   The normal landing parameter doesn't work with additional url parameters. 
			var authorize_url = o.url + '/oauth/authorize?' + ohauth.qsString({
                oauth_token: resp.oauth_token,
                oauth_callback: o.fullLanding || location.href.replace('index.html', '').replace(/#.*/, '') + o.landing
            });
    ...
    oauth.options = function(_) {
        ...
        o.url = 'https://www.openstreetmap.org';
